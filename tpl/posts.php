        ...
        <div id="wrapper">
            ...
            <section id="content">
                <div id="posts">
                    <article class="group">
						...
						{loop="posts"}
                        <div class="post">
                            <img src="{$value.image}" height="100px" alt="{$value.post}" title="{$value.post}" />
							<h2><a href="post.php?id={$value.id}" title="{$value.post}">{$value.post}</a></h2>
            ...
            <aside id="sidebar">
                <section class="box">
                    ...
                    <ul class="nav">
						{loop="postcategories"}
                        <li><a href="posts.php?id={$value.id}">{$value.category}</a></li>
						{/loop}
                    </ul>
                </section>
                <section class="box">
